...
a = bold.Agent(U2D_DEV_NAME, CONF_FILE_PATH, MOTION_FILE_PATH, TEAM_NUMBER, UNIFORM_NUMBER, USE_JOYSTICK, AUTO_GET_UP, USE_OPTION_TREE, RECORD_FRAMES, IGNORE_GAME_CONTROLLER)
